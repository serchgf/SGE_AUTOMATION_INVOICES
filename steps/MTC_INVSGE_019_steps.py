def MTC_INVSGE_019_steps(sge_funct):
    ...
    sge_funct.press_hotkeys('ctrl+w')
    print(
        "26 Posicionados en la columna Forma de Pago presionamos 4 veces la flecha abajo para posicionarse en tarjeta debito")
    sge_funct.flecha_abajo()
    sge_funct.flecha_abajo()
    sge_funct.flecha_abajo()
    sge_funct.flecha_abajo()
    print("27 Capturar el total a liquidar")
    sge_funct.send_text('6,615.02')
