...
def MTC_INVSGE_014_steps(sge_funct):
    print("PASO")
    ...
    sge_funct.press_hotkeys('ctrl+w')
    print("31 Posicionados en la columna Forma de Pago presionamos 4 veces la flecha abajo para posicionarse en tarjeta debito")
    sge_funct.flecha_abajo()
    sge_funct.flecha_abajo()
    sge_funct.flecha_abajo()
    sge_funct.flecha_abajo()
    print("32 Capturar el total a liquidar")
    sge_funct.send_text('4,432.01')
    ...
    print("36 Presionamos ctrl + W para facturar lo capturado en la ventada del detalle esperar 5 segundos")
    sge_funct.press_hotkeys('ctrl+w')
    sge_funct.segundos_de_espera(5)
