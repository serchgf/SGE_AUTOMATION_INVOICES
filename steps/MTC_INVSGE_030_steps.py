...
def MTC_INVSGE_030_steps(sge_funct, img_inicioFactura):
    # -------------------------------------------------------------------------3
    ...
    print("7 Teclear input")
    sge_funct.press_enter()
    print("8 Capturamos la opción 1 Cancelacion de descuentos.")
    sge_funct.send_text('2')
    print("9 Teclear input")
    sge_funct.press_enter()
    print("10 Pegar el numero de cuenta con clic derecho")
    sge_funct.send_text(num_cuenta)
    print("11 Teclear input")
    sge_funct.press_enter()
    print("12 Capturar el concepto Descuento improcedente 60")
    sge_funct.send_text('60')
    print("13 En el campo factura pegar el numero de la factura con clic derecho")
    sge_funct.send_text(num_factura)
    print("14 Teclear input")
    sge_funct.press_enter()
    print("15 Teclear input")
    sge_funct.press_enter()
    print("16 Capturar el importe Movto.")
    sge_funct.send_text('10')
    print("17 Teclear input")
    sge_funct.press_enter()
