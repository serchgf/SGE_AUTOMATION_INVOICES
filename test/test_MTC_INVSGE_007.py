...
from steps import MTC_INVSGE_007_steps


#@ddt
class MTC_INVSGE_007_Tests(unittest.TestCase):

    #@file_data("./Config/TestDataset/dataSet_ddt_invoice_credit_simple_order.json")
    #@pytest.mark.flaky(reruns=1)
    @pytest.mark.invoices(reruns=1)
    def test_MTC_INVSGE_007(self):
        ...
        MTC_INVSGE_007_steps.MTC_INVSGE_007_steps(sge_funct)
