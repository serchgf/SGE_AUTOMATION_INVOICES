...
from steps import MTC_INVSGE_012_steps


#@ddt
class MTC_ASGE_012_Tests(unittest.TestCase):

        #@file_data("./Config/TestDataset/dataSet_ddt_invoice_credit_simple_order.json")
    @pytest.mark.flaky(reruns=1)
    def test_MTC_INVSGE_012(self):
        ...
        MTC_INVSGE_012_steps.MTC_INVSGE_012_steps(sge_funct)
