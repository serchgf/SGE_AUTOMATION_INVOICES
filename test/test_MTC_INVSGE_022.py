...
from steps import MTC_INVSGE_022_steps as cmo_steps
...
#@ddt
class MTC_ASGE_022_Tests(unittest.TestCase):
    ...
    def test_MTC_ASGE_022(self):
        ...
        cmo_steps.MTC_INVSGE_022_steps(sge_funct, txt_files_path.carga_masiva_txt)
