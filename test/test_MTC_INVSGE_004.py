...
from steps import MTC_INVSGE_004_steps as inv_steps


#@ddt
class MTC_INVSGE_004_Tests(unittest.TestCase):

    # @file_data("./Config/TestDataset/dataSet_ddt_invoice_credit_simple_order.json")
    @pytest.mark.flaky(reruns=1)
    def test_MTC_INVSGE_004(self):
        ...
        inv_steps.MTC_INVSGE_004_steps(sge_funct)
