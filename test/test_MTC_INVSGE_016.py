...
from steps import MTC_INVSGE_016_steps as inv_steps
# from ddt import ddt, file_data
from Config.config import images


# @ddt
class MTC_AINVSGE_016_Tests(unittest.TestCase):

    # @file_data("./Config/TestDataset/dataSet_ddt_invoice_credit_simple_order.json")
    # @pytest.mark.flaky(reruns=1)
    def test_MTC_AINVSGE_016(self):
        # print("Test using: "+supplier)

        sge_funct = sge_functions2()
        logging.info("------------------------------Test to Create Facturacion sencilla credito plaza kit")
        print("------------------------------Test to Create Facturacion sencilla credito plaza kit")
        ...
        inv_steps.MTC_INVSGE_016_steps(sge_funct)
