...
from steps import MTC_INVSGE_027_steps as inv_steps
# from ddt import ddt, file_data
from Config.config import images


# @ddt
class MTC_AINVSGE_027_Tests(unittest.TestCase):

    # @file_data("./Config/TestDataset/dataSet_ddt_invoice_credit_simple_order.json")
    #@pytest.mark.flaky(reruns=1)
    def test_MTC_AINVSGE_027(self):
        # print("Test using: "+supplier)

        sge_funct = sge_functions2()
        logging.info("------------------------------Test to Create Devolucion factura credito parcial")
        print("------------------------------Test to Create Devolucion factura credito parcial")
        ...
        inv_steps.MTC_INVSGE_027_steps(sge_funct, images.img_inicio_factura)
        ...
        print("Invoice Devolution created succesfull")
