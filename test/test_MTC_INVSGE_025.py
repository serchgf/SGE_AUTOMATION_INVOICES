...
from steps import MTC_INVSGE_025_steps as cmo_steps
...
class MTC_ASGE_025_Tests(unittest.TestCase):
    ...
    def test_MTC_ASGE_025(self):
        ...
        cmo_steps.MTC_INVSGE_025_steps(sge_funct, txt_files_path.carga_masiva_txt)
