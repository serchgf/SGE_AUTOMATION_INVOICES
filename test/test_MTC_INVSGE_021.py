...
from steps import MTC_INVSGE_021_steps as cmo_steps
...
#@ddt
class MTC_ASGE_021_Tests(unittest.TestCase):
    ...
    def test_MTC_ASGE_021(self):
        ...
        cmo_steps.MTC_INVSGE_021_steps(sge_funct, txt_files_path.carga_masiva_txt)
