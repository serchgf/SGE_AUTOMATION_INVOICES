...
from steps import MTC_INVSGE_001_steps as inv_steps
# from ddt import ddt, file_data
from Config.config import images


# @ddt
class MTC_INVSGE_001_Tests(unittest.TestCase):

    # @file_data("./Config/TestDataset/dataSet_ddt_invoice_credit_simple_order.json")
    # @pytest.mark.flaky(reruns=1)
    def test_MTC_INVSGE_001(self):
        ...
        inv_steps.MTC_INVSGE_001_steps(sge_funct)
