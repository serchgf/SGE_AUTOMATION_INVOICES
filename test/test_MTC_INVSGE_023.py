...
from steps import MTC_INVSGE_023_steps as cmo_steps
...
#@ddt
class MTC_ASGE_023_Tests(unittest.TestCase):
    ...
    def test_MTC_ASGE_023(self):
        ...
        cmo_steps.MTC_INVSGE_023_steps(sge_funct, txt_files_path.carga_masiva_20_txt)

        # print("Validating invoice creation")
        # assert sge_funct.validating_invoice_20(), "Error, Invoice not created"
