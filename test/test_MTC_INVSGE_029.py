...
from steps import MTC_INVSGE_029_steps as inv_steps
...
class MTC_AINVSGE_029_Tests(unittest.TestCase):
    ...
    def test_MTC_AINVSGE_029(self):
        ...
        inv_steps.MTC_INVSGE_029_steps(sge_funct, images.img_inicio_factura)
