...
from steps import MTC_INVSGE_026_steps as inv_steps
# from ddt import ddt, file_data
from Config.config import images


# @ddt
class MTC_AINVSGE_026_Tests(unittest.TestCase):

    # @file_data("./Config/TestDataset/dataSet_ddt_invoice_credit_simple_order.json")
    #@pytest.mark.flaky(reruns=1)
    def test_MTC_AINVSGE_026(self):
        # print("Test using: "+supplier)

        sge_funct = sge_functions2()
        logging.info("------------------------------Test to Create Devolucion factura credito total")
        print("------------------------------Test to Create Devolucion factura credito total")
        ...
        inv_steps.MTC_INVSGE_026_steps(sge_funct, images.img_inicio_factura)
